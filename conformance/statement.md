...
| the chain has not been rewritten below the anchored size | RFC 3161 timestamp and Hedera consensus time on the signed checkpoint, daily | 3 | none since 12 September 2026 19:41 UTC: the anchors go to Hedera mainnet, topic 0.0.10856156, under an account of the operator's; the testnet topic 0.0.10275637 holds the history from 7 to 12 September and stays readable |
